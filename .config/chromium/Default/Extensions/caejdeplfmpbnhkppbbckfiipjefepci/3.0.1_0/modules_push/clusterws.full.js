var ClusterWS = function() {
    ...
    var e = function() {
        ...
        e.prototype.publish = function(t) {
            return this.socket.send(this.name, t, "publish"),
            this
        }
        ,
      ...
      , n = function() {
        ...
        return e.prototype.on = function(e, n) {
            if ("[object Function]" !== {}.toString.call(n))
                return t("Listener must be a function");
            this.events[e] = n
        }
        ,
    ...
    return function() {
        ...
        s.prototype.send = function(t, e, n) {
            void 0 === n && (n = "emit"),
            this.websocket.send(this.useBinary ? function(t) {
                for (var e = t.length, n = new Uint8Array(e), o = 0; o < e; o++)
                    n[o] = t.charCodeAt(o);
                return n.buffer
            }(o(t, e, n)) : o(t, e, n))
        }
        ...
        s.prototype.create = function() {
            var e = this
              , n = window.MozWebSocket || window.WebSocket;
            this.websocket = new n(this.options.url),
            this.websocket.binaryType = "arraybuffer",
            this.websocket.onopen = function() {
                e.reconnectionAttempted = 0;
                for (var t = 0, n = Object.keys(e.channels), o = n.length; t < o; t++)
                    e.channels[n[t]] && e.channels[n[t]].subscribe()
            }
            ,
            ...
            this.websocket.onclose = function(t) {
                ...
                e.options.autoReconnect && 1e3 !== t.code && (0 === e.options.autoReconnectOptions.attempts || e.reconnectionAttempted < e.options.autoReconnectOptions.attempts))
                    ...
                    setTimeout(function() {
                        return e.create()
                    }, Math.floor(Math.random() * (e.options.autoReconnectOptions.maxInterval - e.options.autoReconnectOptions.minInterval + 1)))) : console.log("Some thing wrong with close event please contact developer");
                else {
                    e.events.removeAllEvents();
                    for (var n = 0, o = Object.keys(e), s = o.length; n < s; n++)
                        e[o[n]] = null
                }
            }
        }
